...
local Button_Icon = "74263304016149" 
	...
	return function(Config)
		...
		TitleBar.CloseButton = BarButton(Components.Assets.Close, UDim2.new(1, -4, 0, 4), TitleBar.Frame, function()
			Library.Window:Dialog({
				Title = "Close",
				Content = "Are you sure you want to close Miranith?",
				Buttons = {
					{
						Title = "Yes",
						Callback = function()
		...
		function Window:Minimize()
			...
			if not MinimizeNotif then
				...
				if not Mobile then Library:Notify({
					Title = "Miranith",
					Content = "Press " .. Key .. " to toggle miranith.",
					Duration = 6
					})
				else 
					Library:Notify({
						Title = "Miranith",
						Content = "Tap to the miranith logo to toggle miranith.",
						Duration = 6
					})
				end
			end
...
local MinimizeButton = New("TextButton", {
	...
	New("ImageLabel", {
		Image = "rbxassetid://74263304016149",
		Size = UDim2.new(1, 0, 1, 0),
		BackgroundTransparency = 1,
